...
const LandingPage = () => {
  ...
  return (
    <div>
      <ThreeParticles />
      <div className="flex flex-col justify-center items-center w-[100vw] h-[100vh] font-['NextPage'] absolute top-1/2 left-1/2 z-1 bg-transparent -translate-x-1/2 -translate-y-1/2">
